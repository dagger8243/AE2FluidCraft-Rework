...
public class WirelessBattleStationInventory extends MEMonitorHandler<IAEItemStack>
    implements IWirelessCraftTerminal, IWirelessPatternTerminal {
    ...
    public WirelessBattleStationInventory(final ItemStack is, final int slot, IGridNode gridNode,
                                             EntityPlayer player) {
        super(
    ...
    @Override
    public ItemStack getItemStack() { return this.target; }
